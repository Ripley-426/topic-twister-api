...
import com.example.topic.domain.TopicList
...
class InMemoryTopicLoader : ITopicLoader {
    ...
    private fun addTopics() {
        var animalTopic: Topic = Topic("ANIMALS", mutableListOf(
            ...
            "Chicken", "Chihuahua", "Chipmunk", "Cicada", "Clam", "Clownfish", "Coati", "Cobra", "Cockatoo Cockroach",
            "Cod", "Condor", "Copperhead", "Cougar", "Cow", "Coyote", "Crab", "Crane", "Cricket", "Crocodile", "Crow",
            ...
            "Hummingbird", "Humpback Whale", "Husky", "Iguana", "Impala", "Kangaroo", "Koala", "Lemur", "Leopard",
            "Lion", "Lizard", "Llama", "Lobster", "Marmot", "Monitor lizard", "Monkey", "Moose", "Mosquito", "Moth",
